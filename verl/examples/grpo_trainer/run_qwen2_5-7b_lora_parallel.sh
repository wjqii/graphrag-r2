...
# ============================================================
# Single-stage GRPO training (stage2 reward mode, from base Instruct model)
# For the recommended 2-stage approach, use:
#   1. run_qwen2_5-7b_lora_stage1.sh (learn search behavior)
#   2. run_qwen2_5-7b_lora_stage2.sh (optimize answer quality)
# ============================================================

EXP_NAME=merged-lora-grpo-qwen2.5-7b-it-stage2-only
