...
# ============================================================
# Stage 2: Optimize answer quality (f1_plus + format_punishment)
# This stage takes the Stage 1 checkpoint and optimizes for
# answer accuracy while maintaining proper format.
# - f1_plus: F1 score with search count penalty (a=2, b=0.1)
# - format_punishment: checks tag consistency and answer format
#
# IMPORTANT: Update STAGE1_CHECKPOINT to point to the actual
# Stage 1 output checkpoint before running.
# ============================================================

STAGE1_CHECKPOINT=/agot/graphrag-r1/verl_checkpoints/merged-lora-grpo-qwen2.5-7b-it-stage1/actor/global_step_200
EXP_NAME=merged-lora-grpo-qwen2.5-7b-it-stage2

CUDA_VISIBLE_DEVICES=3 \
python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    +algorithm.reward_mode=stage2 \
