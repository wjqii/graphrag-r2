...
__all__ = ["copy", "exists", "makedirs", "copy_to_local", "is_non_local", "local_mkdir_safe"]
...
def copy_local_path_from_hdfs(src: str, cache_dir=None, filelock='.file.lock', verbose=False, always_recopy=False) -> str:
    ...
    Args:
        ...
        always_recopy (bool): if True, force fresh copy ignoring cache
