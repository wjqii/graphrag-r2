...
class FSDPVLLMShardingManager(BaseShardingManager):
    ...
    def __init__(
        ...
        # self.model_runner = inference_engine.llm_engine.model_executor.driver_worker.model_runner if
        # inference_engine else None

        self.model_runner = (
            self.inference_engine.llm_engine.model_executor.driver_worker.model_runner
    ...
    def __enter__(self):
        ...
        with simple_timer("reshard", self.timing):
            ...
            if (
                ...
                and hasattr(self.inference_engine, "wake_up")
