...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def init_model(self):
        ...
        if self._is_actor:
            ...
            self.checkpoint_manager = FSDPCheckpointManager(
                ...
                checkpoint_config=self.config.actor.get("checkpoint", OmegaConf.create({"load_contents": ["model", "optimizer", "lr_scheduler"], "save_contents": ["model", "optimizer", "lr_scheduler"]})),
            )
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        assert self._is_actor or is_lora
        ...
        if self._is_actor and self.world_size > 1 and fsdp_version(self.actor.actor_module) == 1:
    ...
    def compute_ref_log_prob(self, data: DataProto):
        if self._is_lora and self._is_actor and hasattr(self, 'actor'):
